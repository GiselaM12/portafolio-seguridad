    ...
    return (
        <div className="bg-[#050913]/90 border border-violet-500/20 rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(139,92,246,0.1)] relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-violet-500/20">
                <button onClick={() => setTerminalInput('netdiscover -r 172.16.0.0/16')} className="bg-[#050913] hover:bg-violet-900/20 text-xs font-mono text-gray-400 py-3 flex items-center justify-center gap-2 transition-colors">
                    <FaNetworkWired className="text-violet-500" /> 1. Recon
                </button>
                <button onClick={() => setTerminalInput('smbmap -h 192.168.56.104')} className="bg-[#050913] hover:bg-violet-900/20 text-xs font-mono text-gray-400 py-3 flex items-center justify-center gap-2 transition-colors">
                    <FaPlay className="text-blue-500" /> 2. Enum
                </button>
                <button onClick={() => setTerminalInput('ssh smbuser@192.168.56.104')} className="bg-[#050913] hover:bg-violet-900/20 text-xs font-mono text-gray-400 py-3 flex items-center justify-center gap-2 transition-colors">
                    <FaKey className="text-amber-500" /> 3. Foothold
                </button>
                <button onClick={() => setTerminalInput('./equipo1')} className="bg-[#050913] hover:bg-violet-900/20 text-xs font-mono text-gray-400 py-3 flex items-center justify-center gap-2 transition-colors">
